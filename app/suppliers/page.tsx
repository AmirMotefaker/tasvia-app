...
export const metadata: Metadata = {
  ...
  description: "چشم‌انداز مدیریت ذی‌نفعان و تامین‌کنندگان در تسویا.",
  ...
  return (
    <main className="min-h-screen bg-[#f4f7fb] px-4 py-12 text-[#0b1220] sm:px-6">
      <div className="mx-auto max-w-4xl">
        ...
        <p className="mt-5 text-base leading-8 text-[#5f6c7e]">این بخش در Roadmap تسویا برای ایجاد پرونده مالی هر ذی‌نفع، تاریخچه تسویه، اطلاعات مرجع و کنترل‌های عملیاتی برنامه‌ریزی شده است.</p>
      </div>
    </main>
  );
}
