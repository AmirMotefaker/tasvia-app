...
export const metadata: Metadata={title:"مرکز منابع",description:"راهنماهای تسویا درباره عملیات تسویه، کنترل داخلی، شواهد مالی و مغایرت‌گیری.",alternates:{canonical:"/resources"}};
const guides=[
