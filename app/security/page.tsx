...
export const metadata: Metadata = {
  ...
  description: "اصول امنیت، کنترل دسترسی، audit trail و تفکیک شواهد مالی از تأیید بانکی در تسویا.",
    ...
    <main className="min-h-screen bg-[#f4f7fb] px-4 py-14 text-[#0b1220] sm:px-6">
      <article className="mx-auto max-w-6xl">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 text-base leading-8 text-[#5f6c7e]">تسویا ابتدا لایه کنترل عملیات مالی را می‌سازد. هر اتصال مالی واقعی باید بعداً روی همین مرزهای امنیتی و حسابرسی‌شونده قرار بگیرد.</p>
        </div>
