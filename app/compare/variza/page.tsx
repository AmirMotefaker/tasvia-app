...
export const metadata: Metadata = {
  title: "مقایسه تسوین و واریزا",
  description: "مقایسه شفاف دامنه محصول تسوین و واریزا بر اساس اطلاعات عمومی و وضعیت واقعی قابلیت‌های تسوین.",
  ...
  return (
    <main className="min-h-screen bg-[#f4f7fb] px-4 py-12 text-[#0b1220] sm:px-6">
      <div className="mx-auto max-w-6xl">
        ...
        <h1 className="mt-3 text-4xl font-black leading-[1.4]">تسوین در مقایسه با واریزا</h1>
        <p className="mt-4 max-w-4xl text-sm leading-7 text-[#657184]">این صفحه برای شفافیت دامنه محصولات است، نه ادعای برتری مطلق. اطلاعات واریزا از صفحات عمومی رسمی آن در تاریخ بالا استخراج شده و قابلیت‌های تسوین بر اساس وضعیت واقعی همین محصول برچسب خورده‌اند.</p>
        <div className="mt-8 overflow-x-auto rounded-3xl border border-black/5 bg-white">
          <table className="w-full min-w-[720px] text-right text-sm">
            <thead className="bg-[#0f223d] text-white"><tr><th className="p-4">حوزه</th><th className="p-4">واریزا</th><th className="p-4">تسوین</th></tr></thead>
        ...
        <Link href="/product" className="mt-6 inline-flex rounded-2xl bg-[#0f223d] px-5 py-3 text-sm font-black text-white">مشاهده معماری محصول تسوین</Link>
      </div>
    </main>
  );
}
