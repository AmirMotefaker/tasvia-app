...
export const metadata: Metadata = {
  title: "مدیریت تسویه",
  description: "مدیریت چرخه درخواست، بررسی، شواهد و وضعیت تسویه در تسویا.",
  ...
  return (
    <main className="min-h-screen bg-[#f4f7fb] px-4 py-12 text-[#0b1220] sm:px-6">
      <div className="mx-auto max-w-5xl">
        ...
        <p className="mt-5 max-w-3xl text-base leading-8 text-[#5f6c7e]">هسته تجربه تسویا برای ثبت درخواست، ذی‌نفع، مبلغ، شواهد و وضعیت طراحی شده است. نسخه فعلی یک جریان نمایشی است و انتقال وجه واقعی انجام نمی‌دهد.</p>
