...
export const metadata: Metadata = {
  title: "درباره تسویا",
  description: "درباره محصول تسویا و تمرکز آن بر شفافیت تسویه و عملیات مالی کسب‌وکارها.",
  ...
  return (
    <main className="min-h-screen bg-[#f4f7fb] px-4 py-12 text-[#0b1220] sm:px-6">
      <article className="mx-auto max-w-4xl">
        <h1 className="text-4xl font-black">درباره تسویا</h1>
        <div className="mt-6 space-y-5 text-base leading-8 text-[#5f6c7e]">
          <p>تسویا یک محصول نرم‌افزاری برای شفاف‌تر کردن فرآیند درخواست، پیگیری و گزارش‌پذیری تسویه‌های کسب‌وکاری است.</p>
