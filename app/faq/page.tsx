...
const faq=[
["تسوین چیست؟","تسوین یک محصول در حال توسعه برای مدیریت شفاف گردش‌کار تسویه، شواهد مالی، ذی‌نفعان، مغایرت‌گیری و گزارش عملیاتی کسب‌وکارهاست."],
["آیا تسوین اکنون پول جابه‌جا می‌کند؟","خیر. نسخه عمومی فعلی انتقال وجه واقعی یا اتصال فعال بانکی و PSP انجام نمی‌دهد."],
["رسید در تسوین به معنی تأیید پرداخت است؟","خیر. رسید و مدرک، شواهد عملیاتی هستند. تأیید قطعی پرداخت باید از منبع معتبر بانکی یا PSP دریافت شود."],
...
["قیمت تسوین چقدر است؟","تعرفه عمومی هنوز نهایی نشده است. در مرحله دسترسی اولیه، دامنه پایلوت و نیاز عملیاتی ابتدا مشخص می‌شود."],
