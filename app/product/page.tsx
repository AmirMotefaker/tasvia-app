...
export const metadata: Metadata = {
  title: "محصول",
  description: "تسویا چگونه درخواست‌های تسویه، شواهد مالی، وضعیت‌ها و تاریخچه عملیات را در یک مسیر شفاف مدیریت می‌کند.",
  ...
  return (
    <main className="min-h-screen bg-[#f4f7fb] px-4 py-12 text-[#0b1220] sm:px-6">
      <div className="mx-auto max-w-4xl">
        <div className="text-xs font-black text-[#008f87]">محصول تسویا</div>
        <h1 className="mt-3 text-4xl font-black leading-[1.4]">یک جریان واحد برای درخواست، بررسی، شواهد و وضعیت تسویه</h1>
        <p className="mt-5 text-base leading-8 text-[#5f6c7e]">تسویا تلاش می‌کند نقاط پراکنده عملیات مالی را به یک مسیر قابل پیگیری تبدیل کند؛ از ثبت درخواست تا مرور شواهد، وضعیت و تاریخچه رویدادها.</p>
